                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order">
                            ...
                            <ul>
                                ...
                                <input type="submit" name="submit_buy"  value="Place Order" style="margin-left: 70px; font-size: 30px;  padding: 0 10px;background:#395dad; color: white; ">
                                <!-- <a href="success.php"  type="submit" name="submit_buy" style="margin-left: 70px; font-size: 30px;  padding: 0 10px;background:#395dad; color: white; ">Place Order</a> -->
                            </div>
                        </div>
                    </div>
                </form>
